...
//将需要调用的模块使用 strcat 作拼接;
    ...
    const std::string failure_rate_model_file = "/home/gaosm/tmp/inforefiner-model/model-data/LightGBM_model_failure_rate.txt";
    const std::string repair_cost_model_file =  "/home/gaosm/tmp/inforefiner-model/model-data/LightGBM_model_repair_cost.txt";
