...
void LightGBMPredict::predict(std::vector<float> &row){
    ...
    int64_t out_len;
    int res = LGBM_BoosterPredictForMat(this->handle, in_p, C_API_DTYPE_FLOAT32, 1, 28, 1, C_API_PREDICT_NORMAL, 0, -1, "", &out_len, out_result);
